...
abstract contract Contracts is CeloChains {
    ...
    mapping(bytes32 contractName => bytes getterCallData)
        private governanceFactoryLookupCalldata;
    ...
    constructor() {
        ...
        governanceFactoryLookupCalldata[keccak256("MentoToken")] = abi
            .encodeWithSignature("mentoToken()");
        governanceFactoryLookupCalldata[keccak256("Emission")] = abi
            .encodeWithSignature("emission()");
        governanceFactoryLookupCalldata[keccak256("GovernanceTimelock")] = abi
            .encodeWithSignature("governanceTimelock()");
        governanceFactoryLookupCalldata[keccak256("MentoGovernor")] = abi
            .encodeWithSignature("mentoGovernor()");
        governanceFactoryLookupCalldata[keccak256("Locking")] = abi
            .encodeWithSignature("locking()");
        governanceFactoryLookupCalldata[keccak256("Airgrab")] = abi
            .encodeWithSignature("airgrab()");
    }
    ...
    ) internal view returns (address payable found) {
    ...
    function _lookupGovernanceFactory(
        ...
        bytes memory getter = governanceFactoryLookupCalldata[
